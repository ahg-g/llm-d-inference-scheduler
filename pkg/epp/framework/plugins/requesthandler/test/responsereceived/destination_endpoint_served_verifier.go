...
import (
	...
	"github.com/llm-d/llm-d-router/pkg/epp/framework/plugins/requesthandler/test"
...
var _ fwkrhapi.ResponseHeaderProcessor = &DestinationEndpointServedVerifier{}
...
func (desv *DestinationEndpointServedVerifier) ResponseHeader(ctx context.Context, request *fwksched.InferenceRequest, response *fwkrhapi.Response, _ *fwkdl.EndpointMetadata) {
