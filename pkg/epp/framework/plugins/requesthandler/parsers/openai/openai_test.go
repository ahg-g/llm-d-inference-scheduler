...
func TestOpenAIParser_ParseRequest(t *testing.T) {
	...
	tests := []struct {
		...
		body    map[string]any
		want    *fwkrhapi.InferenceRequestBody
		wantErr bool
	}{
		{
			...
			want: &fwkrhapi.InferenceRequestBody{
				Completions: &fwkrhapi.CompletionsRequest{
					Prompt: fwkrhapi.Prompt{Raw: "test prompt"},
				},
				Payload: fwkrhapi.PayloadMap{
					"model":  "test",
					"prompt": "test prompt",
				},
			},
		},
		{
			...
			want: &fwkrhapi.InferenceRequestBody{
				Completions: &fwkrhapi.CompletionsRequest{
					Prompt: fwkrhapi.Prompt{Strings: []string{"Why is the sky blue?"}},
				},
				Payload: fwkrhapi.PayloadMap{
					"model":  "test",
					"prompt": []any{"Why is the sky blue?"},
		...
		},
		{
			...
			want: &fwkrhapi.InferenceRequestBody{
				Completions: &fwkrhapi.CompletionsRequest{
					Prompt: fwkrhapi.Prompt{Strings: []string{"prompt1", "prompt2"}},
				},
				Payload: fwkrhapi.PayloadMap{
					"model":  "test",
					"prompt": []any{"prompt1", "prompt2"},
		...
		},
		{
			...
			want: &fwkrhapi.InferenceRequestBody{
				Completions: &fwkrhapi.CompletionsRequest{
					Prompt: fwkrhapi.Prompt{TokenIDs: []uint32{1, 2, 3}},
				},
				Payload: fwkrhapi.PayloadMap{
					"model":  "test",
			...
			want: &fwkrhapi.InferenceRequestBody{
				ChatCompletions: &fwkrhapi.ChatCompletionsRequest{
					Messages: []fwkrhapi.Message{
						{Role: "system", Content: fwkrhapi.Content{Raw: "this is a system message"}},
						{Role: "user", Content: fwkrhapi.Content{Raw: "hello"}},
					},
				},
				Payload: fwkrhapi.PayloadMap{
					"model": "test",
		...
		},
		{
			...
			want: &fwkrhapi.InferenceRequestBody{
				ChatCompletions: &fwkrhapi.ChatCompletionsRequest{
					Messages: []fwkrhapi.Message{
						{Role: "system", Content: fwkrhapi.Content{
						...
						{Role: "user", Content: fwkrhapi.Content{
							Structured: []fwkrhapi.ContentBlock{
								{
									Type:     "image_url",
									ImageURL: fwkrhapi.ImageBlock{URL: "https://example.com/images/dui.jpg."},
								},
							},
						}},
					},
					...
					Messages: []fwkrhapi.Message{
						{Role: "user", Content: fwkrhapi.Content{
							Structured: []fwkrhapi.ContentBlock{
								{
									Type:       "input_audio",
									InputAudio: fwkrhapi.AudioBlock{Data: "base64data", Format: "wav"},
								},
								{
									Type:     "video_url",
									VideoURL: fwkrhapi.VideoBlock{URL: "https://example.com/video.mp4"},
								},
							},
						}},
					},
		...
		},
		{
			...
			want: &fwkrhapi.InferenceRequestBody{
				ChatCompletions: &fwkrhapi.ChatCompletionsRequest{
					Messages:                  []fwkrhapi.Message{{Role: "user", Content: fwkrhapi.Content{Raw: "hello"}}},
					Tools:                     []any{map[string]any{"type": "function"}},
					Documents:                 []any{map[string]any{"content": "doc"}},
		...
		// Embeddings API tests
		{
			...
			want: &fwkrhapi.InferenceRequestBody{
				Embeddings: &fwkrhapi.EmbeddingsRequest{
					Input: fwkrhapi.EmbeddingsInput{Raw: "The food was delicious and the waiter..."},
				},
				Payload: fwkrhapi.PayloadMap{
					"model": "text-embedding-3-small",
					"input": "The food was delicious and the waiter...",
		...
		},
		{
			...
			want: &fwkrhapi.InferenceRequestBody{
				Embeddings: &fwkrhapi.EmbeddingsRequest{
					Input: fwkrhapi.EmbeddingsInput{Strings: []string{"First document", "Second document"}},
				},
				Payload: fwkrhapi.PayloadMap{
					"model": "text-embedding-3-small",
					"input": []any{"First document", "Second document"},
		...
		},
		{
			...
			want: &fwkrhapi.InferenceRequestBody{
				Embeddings: &fwkrhapi.EmbeddingsRequest{
					Input: fwkrhapi.EmbeddingsInput{TokenIDs: []uint32{1, 2, 3}},
				},
				Payload: fwkrhapi.PayloadMap{
					"model": "text-embedding-3-small",
		...
		},
		{
			...
			want: &fwkrhapi.InferenceRequestBody{
				Embeddings: &fwkrhapi.EmbeddingsRequest{
					Input:     fwkrhapi.EmbeddingsInput{Raw: "embed this text"},
		...
		},
		{
			...
			want: &fwkrhapi.InferenceRequestBody{
				Embeddings: &fwkrhapi.EmbeddingsRequest{
					Input: fwkrhapi.EmbeddingsInput{Raw: "text to embed"},
				},
				Payload: fwkrhapi.PayloadMap{
					"model": "text-embedding-3-small",
					"input": "text to embed",
