...
func TestVllmGRPCParser_ParseRequest(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			want: &fwkrhapi.InferenceRequestBody{
				Completions: &fwkrhapi.CompletionsRequest{
					Prompt: fwkrhapi.Prompt{TokenIDs: []uint32{101, 102, 103, 104, 105}},
				},
				Payload: fwkrhapi.PayloadProto{
					Message: &pb.GenerateRequest{
						Input: &pb.GenerateRequest_Tokenized{
				...
				TokenizedPrompt: &fwkrhapi.TokenizedPrompt{
					...
					MultiModalFeatures: []fwkrhapi.MultiModalFeature{
						{Modality: fwkrhapi.ModalityImage, Hash: "hash-a", Offset: 1, Length: 2},
						{Modality: fwkrhapi.ModalityImage, Hash: "hash-b", Offset: 4, Length: 1},
					},
				},
			},
		},
		{
			...
			want: &fwkrhapi.InferenceRequestBody{
				Completions: &fwkrhapi.CompletionsRequest{
					Prompt: fwkrhapi.Prompt{TokenIDs: []uint32{201, 202, 203, 204}},
				},
				Payload: fwkrhapi.PayloadProto{
					Message: &pb.GenerateRequest{
						Input: &pb.GenerateRequest_Tokenized{
				...
				TokenizedPrompt: &fwkrhapi.TokenizedPrompt{
					...
					MultiModalFeatures: []fwkrhapi.MultiModalFeature{
						{Modality: fwkrhapi.ModalityImage, Hash: "hash-only", Offset: 0, Length: 1},
						{Modality: fwkrhapi.ModalityImage, Hash: "", Offset: 2, Length: 2},
					},
				},
			},
		},
