...
var _ fwkrhapi.ResponseBodyProcessor = &Plugin{}
...
func (p *Plugin) ResponseBody(ctx context.Context, request *scheduling.InferenceRequest, response *fwkrhapi.Response,
...
func (p *Plugin) getCelData(response *fwkrhapi.Response) (any, error) {
