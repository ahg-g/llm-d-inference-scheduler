...
import (
	...
	inflightloadconstants "github.com/llm-d/llm-d-router/pkg/epp/framework/plugins/requesthandler/dataproducer/inflightload/constants"
)
...
var (
	_ fwkrhapi.PreRequest            = &InFlightLoadProducer{}
	_ fwkrhapi.ResponseBodyProcessor = &InFlightLoadProducer{}
	_ fwkrhapi.DataProducer          = &InFlightLoadProducer{}
