...
import (
	...
	approxprefixconstants "github.com/llm-d/llm-d-router/pkg/epp/framework/plugins/requesthandler/dataproducer/approximateprefix/constants"
)
...
var (
	_ fwkrhapi.DataProducer = &dataProducer{}
	_ fwkrhapi.PreRequest   = &dataProducer{}
)
