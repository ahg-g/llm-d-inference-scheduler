	...
	req1 := &fwksched.InferenceRequest{
		...
		Body: &fwkrhapi.InferenceRequestBody{
			Completions: &fwkrhapi.CompletionsRequest{
				Prompt: fwkrhapi.Prompt{Raw: "aaaabbbb"},
			},
		},
	}
...
func TestPrefixPluginCompletion(t *testing.T) {
	...
	req1 := &fwksched.InferenceRequest{
		...
		Body: &fwkrhapi.InferenceRequestBody{
			Completions: &fwkrhapi.CompletionsRequest{
				Prompt: fwkrhapi.Prompt{Raw: "aaaaaa"},
			},
		},
	}
		...
		Body: &fwkrhapi.InferenceRequestBody{
			ChatCompletions: &fwkrhapi.ChatCompletionsRequest{
				Messages: []fwkrhapi.Message{
					{Role: "system", Content: fwkrhapi.Content{Raw: "You are a helpful assistant"}},
					{Role: "user", Content: fwkrhapi.Content{Raw: "Hello, how are you?"}},
					{Role: "assistant", Content: fwkrhapi.Content{Raw: "I'm doing well, thank you! How can I help you today?"}},
					{Role: "user", Content: fwkrhapi.Content{Raw: "Can you explain how prefix caching works?"}},
				},
			},
		},
	}
				...
				Messages: []fwkrhapi.Message{
					{
						...
						Content: fwkrhapi.Content{
							Structured: []fwkrhapi.ContentBlock{
								...
								{Type: "image_url", ImageURL: fwkrhapi.ImageBlock{URL: "https://storage.googleapis.com/abc1/sample1.jpg"}},
							},
						},
					},
				},
				...
				Messages: []fwkrhapi.Message{
					{
						...
						Content: fwkrhapi.Content{
							Structured: []fwkrhapi.ContentBlock{
								{Type: "text", Text: "Describe"},
								{Type: "image_url", ImageURL: fwkrhapi.ImageBlock{URL: "https://storage.googleapis.com/bucket1/sample1.jpg"}},
							},
						},
					},
				},
				...
				Messages: []fwkrhapi.Message{
					{
						...
						Content: fwkrhapi.Content{
							Structured: []fwkrhapi.ContentBlock{
								{Type: "text", Text: "Describe"},
								{Type: "image_url", ImageURL: fwkrhapi.ImageBlock{URL: "https://storage.googleapis.com/bucket2/sample2.jpg"}},
							},
						},
					},
					{Role: "assistant", Content: fwkrhapi.Content{Raw: "This is a sample image."}},
					{Role: "user", Content: fwkrhapi.Content{Raw: "What else do you see?"}},
				},
			},
		},
	}
	...
	req := &fwksched.InferenceRequest{
		...
		Body: &fwkrhapi.InferenceRequestBody{
			Completions: &fwkrhapi.CompletionsRequest{
				...
				Prompt: fwkrhapi.Prompt{Raw: strings.Repeat("a", 128)},
			},
		},
	}
...
func TestMaxPrefixTokensToMatch(t *testing.T) {
	...
	req := &fwksched.InferenceRequest{
		...
		Body: &fwkrhapi.InferenceRequestBody{
			Completions: &fwkrhapi.CompletionsRequest{
				Prompt: fwkrhapi.Prompt{Raw: "aaaabbbbccccdddd"},
			},
		},
	}
