...
func createTestInferenceRequest(reqID string, ttftSLO, tpotSLO float64) *fwksched.InferenceRequest {
	return createTestInferenceRequestWithBody(reqID, ttftSLO, tpotSLO, &fwkrhapi.InferenceRequestBody{
	...
	return createTestInferenceRequestWithBody(reqID, ttftSLO, tpotSLO, &fwkrhapi.InferenceRequestBody{
		ChatCompletions: &fwkrhapi.ChatCompletionsRequest{
			Messages: []fwkrhapi.Message{
				...
				{Role: "user", Content: fwkrhapi.Content{Raw: "Tell me a joke."}},
			},
		},
	})
}

func createTestInferenceRequestWithBody(reqID string, ttftSLO, tpotSLO float64, body *fwkrhapi.InferenceRequestBody) *fwksched.InferenceRequest {
