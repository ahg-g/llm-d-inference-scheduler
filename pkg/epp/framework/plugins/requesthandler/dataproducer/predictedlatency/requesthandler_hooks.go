...
import (
	...
	latencypredictor "github.com/llm-d/llm-d-router/pkg/epp/framework/plugins/requesthandler/dataproducer/predictedlatency/latencypredictorclient"
...
var _ fwkrhapi.PreRequest = &PredictedLatency{}
var _ fwkrhapi.ResponseHeaderProcessor = &PredictedLatency{}
var _ fwkrhapi.ResponseBodyProcessor = &PredictedLatency{}
...
func (pl *PredictedLatency) ResponseHeader(ctx context.Context, request *fwksched.InferenceRequest, response *fwkrhapi.Response, targetMetadata *fwkdl.EndpointMetadata) {
	logger := log.FromContext(ctx)
	if request == nil {
...
func (pl *PredictedLatency) ResponseBody(ctx context.Context, request *fwksched.InferenceRequest, response *fwkrhapi.Response, targetMetadata *fwkdl.EndpointMetadata) {
	logger := log.FromContext(ctx)
	if request == nil {
